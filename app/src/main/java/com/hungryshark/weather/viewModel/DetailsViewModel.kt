...
import com.hungryshark.weather.repository.DetailsRepository
import com.hungryshark.weather.repository.DetailsRepositoryImpl
import com.hungryshark.weather.repository.RemoteDataSource
...
class DetailsViewModel(
    ...
    private val callBack = object : Callback<WeatherDTO> {
        ...
        private fun checkResponse(serverResponse: WeatherDTO): AppState {
            ...
            return if (fact?.temp == null || fact.feels_like == null ||
